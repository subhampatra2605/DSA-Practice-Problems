...
class Solution {
    public int[] topKFrequent(int[] nums, int k) {
        ...
        for (int n : nums) {
            count.put(n, count.getOrDefault(n, 0) + 1); // Give me the current frequency of n if it exists in the map.
                                                        If it does NOT exist, give me 0 and We increment the count as we saw the number                                                           one more time.
        }
